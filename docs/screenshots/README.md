...
Captured via `./build/zwriter --capture-screenshots docs/screenshots` (xvfb-run on CI/headless).
...
| `full-page.png` | Full Page view — centered **A4** at true DIP size + 12 pt typewriter density (Lorem body; page guides) |
